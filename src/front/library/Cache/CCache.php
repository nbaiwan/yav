 ...
 * @since 1.0
 */
abstract class Cache_CCache extends CComponent implements ICache, ArrayAccess {
	/**
	...
	public function init() {
		...
		if($this->keyPrefix === null) {
			$this->keyPrefix = ''; //Yaf_Application::app()->get_id();
        }
	}
	...
	protected function setValue($key,$value,$expire) {
		throw new CException(__CLASS__ . ' does not support set() functionality.');
	}
	...
	protected function addValue($key,$value,$expire) {
		throw new CException(__CLASS__ . ' does not support add() functionality.');
	}
	...
	protected function deleteValue($key) {
		throw new CException(__CLASS__ . ' oes not support delete() functionality.');
	}
