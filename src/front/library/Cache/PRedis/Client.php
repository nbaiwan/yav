...
class Predis_CommandPipeline {
    ...
    public function __construct(Cache_Predis_Client $redisClient, Predis_Pipeline_IPipelineExecutor $executor = null) {
    ...
    public function __destruct() {
    	unset($this->_redisClient, $this->_executor);
    }
...
class Predis_MultiExecBlock {
    ...
    public function __construct(Cache_Predis_Client $redisClient, Array $options = null) {
    ...
    private function checkCapabilities(Cache_Predis_Client $redisClient) {
...
class Predis_PubSubContext implements Iterator {
    ...
    public function __construct(Cache_Predis_Client $redisClient) {
        $this->checkCapabilities($redisClient);
        $this->_redisClient = $redisClient;
