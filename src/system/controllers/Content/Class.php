...
class Content_ClassController extends SystemController {
	...
	public function actionCreate($id = 0) {
		if($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			$flag = $this->db->insert('{{content_archives_classes}}',
				array(
					'class_id' => 0,
			...
			$class_name = $_POST['Class']['class_name'];
			if($flag) {
				$content_model_id = $this->db->getLastInsertID();
				//更新缓存
	...
	public function actionUpdate($id) {
		if($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			$flag = $this->db->update('{{content_archives_classes}}',
				array(
					'class_name' => $_POST['Class']['class_name'],
					'content_model_id' => $_POST['Class']['content_model_id'],
					'class_identify' => $_POST['Class']['class_identify'],
	...
	public function actionDelete($id) {
		...
		$this->db->update('{{content_archives_classes}}',
			array(
				'class_status' => 0,
			),
			'class_id=:class_id',
