...
class Db_CDbConnection extends CComponent {
	 ...
	 * @since 1.0.5
	 */
	public $enable_paramLogging=false;
	/**
	...
	public function getSchema()
	{
		if($this->_schema!==null) {
			...
			if(isset($this->driver_map[$driver])) {
				//return $this->_schema=Yii::createComponent($this->driver_map[$driver], $this);
                return $this->_schema=new $this->driver_map[$driver]($this);
			} else {
				/*
