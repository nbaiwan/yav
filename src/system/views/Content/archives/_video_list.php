...
$this->menu=array(
	array('label'=>'游戏管理'),
	array('label'=>'游戏视频', 'cur'=>true, 'url'=>url($this->module->id . '/Content/3/13/Archives/Index')),
...
?>
	...
	<!--
		function srchforum() {
			...
			var search_url = '<?php echo url($this->module->id . '/Content/3/13{game_id}/Archives{search_key}/Index'); ?>';
