...
$this->menu=array(
	array('label'=>'文档管理'),
	array('label'=>'图库管理', 'cur'=>true, 'url'=>url($this->module->id . '/Content/2/Archives/Index')),
	array('label'=>'添加图片', 'url'=>url($this->module->id . '/Content/2/Archives/Create')),
);
...
?>
	...
	<!--
		...
		var search_url = '<?php echo url($this->module->id . '/Content/2/12{game_id}/Archives{search_key}/Index'); ?>';
